...
class Line(object):
    ...
    #两条直线是否相等：
        #特殊情况：如果某条直线的法向量是0向量
        #l1,l2平行
        #在l1取一点，l2取一点，连接这两点的向量的与任意一一条直线的法向量是否正交
            # 正交：同一条直线
            # 不正交： 平行的两条直线
    def __eq__(self, ell):
...
elll1 = Line(normal_vector=Vector(['4.046', '2.836']), constant_term="1.21")
elll2 = Line(normal_vector=Vector(['10.115', '7.09']), constant_term="3.025")
print '#1'
print elll1.intersection_with(elll2)

elll3 = Line(normal_vector=Vector(['7.204', '3.182']), constant_term="8.68")
elll4 = Line(normal_vector=Vector(['8.172', '4.114']), constant_term="9.883")
print '\n#2'
print elll3.intersection_with(elll4)
# # #
elll5 = Line(normal_vector=Vector(['1.182', '5.562']), constant_term="6.744")
elll6 = Line(normal_vector=Vector(['1.773', '8.343']), constant_term="9.525")
print '\n#3'
print elll5.intersection_with(elll6)
